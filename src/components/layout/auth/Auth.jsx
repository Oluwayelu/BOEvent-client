...
const Auth = ({ children, title }) => {
  ...
  return (
    <div className="w-full h-screen relative flex justify-end">
      ...
      <div className="w-full lg:w-2/3 h-full px-5 lg:px-40 relative flex flex-col items-center lg:items-end">
        ...
        <div className="relative w-full lg:w-2/3 h-full inline-flex flex-col lg:justifycenter space-y-5 overflow-auto no-scrollbar">
